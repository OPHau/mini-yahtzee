    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.gameboard}>
                ...
                <Text style={styles.gameinfo}>GOAL: To get as many points as much as possible. A total score of {Constants.BONUS_POINTS_LIMIT} scores you additional {Constants.BONUS_POINTS} points.</Text>
